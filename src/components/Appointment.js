                            ...
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5 class="mb-0">BDS, MDS - Orthopadic Surgery</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="appointments">
                        ...
                        <div class="appointment-list">
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    <h3><a href="patient-profile.html">Harshil Mehta</a></h3>
                                    <div class="patient-details">
                                        <h5><i class="far fa-clock"></i> 13 April 2019, 10.00 AM</h5>
                                        <h5><i class="fas fa-map-marker-alt"></i> Navrangpura, Ahmedabad</h5>
                                        <h5><i class="fas fa-envelope"></i> harshil.mehta.sa@gmail.com</h5>
                                        <h5 class="mb-0"><i class="fas fa-phone"></i> +91 940 900 6358 </h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="appointment-list">
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    <h3><a href="patient-profile.html">Urvashi Vyas </a></h3>
                                    <div class="patient-details">
                        ...
                        <div class="appointment-list">
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5><i class="far fa-clock"></i> 14 April 2022, 9:00 PM</h5>
                                        <h5><i class="fas fa-map-marker-alt"></i> Vile Pale ,Bhavnagar </h5>
                                        <h5><i class="fas fa-envelope"></i> yashvachhani6070@gmail.com</h5>
                                        <h5 class="mb-0"><i class="fas fa-phone"></i> +91 944 546 4444</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="appointment-action">
                        ...
                        <div class="appointment-list">
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    <h3><a href="patient-profile.html">Jainam Doshi</a></h3>
                                    <div class="patient-details">
                                        <h5><i class="far fa-clock"></i> 09 April 2022, 5:00 AM</h5>
                                        <h5><i class="fas fa-map-marker-alt"></i> Mumbai Selling, Mumbai</h5>
                                        <h5><i class="fas fa-envelope"></i>Jainamdoshi0715@gmail.com</h5>
                                        <h5 class="mb-0"><i class="fas fa-phone"></i> +91 948 455 4120</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="appointment-action">
