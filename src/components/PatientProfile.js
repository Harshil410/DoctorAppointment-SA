									...
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<h5 class="d-block mb-0">Dr. Harshad Mehta </h5>
												<span class="d-block text-sm text-muted">Orthopedic</span>
												<span class="d-block text-sm text-muted">13 April 2022 5.00 PM</span>
											</div>
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<h5 class="d-block mb-0">Dr. Rakesh JunjunWala </h5>
												<span class="d-block text-sm text-muted">Dentist</span>
												<span class="d-block text-sm text-muted">12 April 2022 11.00 AM</span>
											</div>
										</div>
									</li>
								</ul>
														...
														<table class="table table-hover table-center mb-0">
															...
															<tbody>
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Harshad Mehta<span>Orthopedic</span></a>
																		</h2>
																	</td>
																	<td>12 April 2022 <span class="d-block text-info">10.00 AM</span></td>
																	<td>16 April 2022</td>
																	<td>Rs.400</td>
																	<td>16 April 2022</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Rakesh JunJunwala <span>Dental</span></a>
																		</h2>
																	</td>
																	<td>13 April 2022 <span class="d-block text-info">8.00 PM</span></td>
																	<td>14 April 2022</td>
																	<td>Rs.250</td>
																	<td>14 April 2022</td>
																	<td><span class="badge badge-pill bg-success-light">Confirm</span></td>
																...
																<tr>
																	...
																	<td>11 April 2022 <span class="d-block text-info">9:00 PM</span></td>
																	<td>12 April 2022</td>
																	<td>Rs. 450</td>
																	<td>15 April 2022</td>
																	<td><span class="badge badge-pill bg-success-light">Confirm</span></td>
																...
																<tr>
																	...
																	<td>14 April 2022 <span class="d-block text-info">9.00 PM</span></td>
																	<td>14 April 2022</td>
																	<td>Rs. 275</td>
																	<td>16 April 2022</td>
